 ...
 */
exports.jobsByCategory = function(req, res) {

	Job.where('category', req.category._id).sort('-created').populate('category', 'name').exec(function(err, jobs){
...
/**
 * Create Jobs by category
 */

exports.createjobsByCategory = function(req, res) { 
...
/**
 * Update Jobs by category
 */

exports.updatejobsbyCategory = function(req, res){
	var job = req.job;
